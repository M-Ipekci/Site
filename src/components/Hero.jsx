      ...
      <div className="min-h-screen relative flex md:flex-row flex-col-reverse md:items-end justify-center items-center">
        <div
          className={`absolute h-full md:w-4/12 w-8/12 top-0 right-0 bottom-0 z-10 ${
            showContent ? "opacity-100 translate-x-0 transition-opacity ease-in duration-500" : "opacity-0 translate-x-10"
          } bg-primaryLinear`}
        >
          <h2 className="rotate-90 absolute top-[30%] right-[15%]" style={{ fontSize: '3rem' }}>Your Hero Title</h2>
        </div>
        ...
        {showContent && (
          ...
          >
            {/* Your Spline 3D model component was here */}
          </div>
        )}
      </div>
    </section>
